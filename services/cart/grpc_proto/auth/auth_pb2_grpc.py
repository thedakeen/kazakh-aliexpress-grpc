...
import grpc_proto.auth.auth_pb2 as auth__pb2
...
class AuthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.IsTokenValid = channel.unary_unary(
            "/auth.Auth/IsTokenValid",
            request_serializer=auth__pb2.IsTokenValidRequest.SerializeToString,
            response_deserializer=auth__pb2.IsTokenValidResponse.FromString,
            _registered_method=True,
        )
...
class AuthServicer(object):
    ...
    def IsTokenValid(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_AuthServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "IsTokenValid": grpc.unary_unary_rpc_method_handler(
            servicer.IsTokenValid,
            request_deserializer=auth__pb2.IsTokenValidRequest.FromString,
            response_serializer=auth__pb2.IsTokenValidResponse.SerializeToString,
        ),
    }
...
class Auth(object):
    ...
    def IsTokenValid(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/auth.Auth/IsTokenValid",
            auth__pb2.IsTokenValidRequest.SerializeToString,
            auth__pb2.IsTokenValidResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
